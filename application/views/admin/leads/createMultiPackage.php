                ...
                <div class="panel_s">
                    <div class="panel-body">
                     ...
                     Deal Acquired
                        ...
                        <form class="create_package_form" id="create_package_form" method="post" name="create_package_form" action="<?php echo admin_url('Leads/createMuliplePackage'); ?>">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group" app-field-wrapper="author_name">
                                        ...
                                        <input type="text" id="author_name" name="author_name" class="form-control" readonly value="<?= $leadData->author_name; ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="msstatus" name="msstatus" class="form-control" tabindex="-98">
                                            ...
                                            <option value="in_process" <?php if ($leadData->ms_status == 'in_process') {
                                                                            echo "selected";
                                                                        } ?>>In-process</option>
                                            <option value="completed" <?php if ($leadData->ms_status == 'completed') {
                                                                            echo "selected";
                                                                        } ?>>Completed</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group book_type">
                                        ...
                                        <select id="book_type" name="book_type" class="form-control book_type_standard_and_custum" tabindex="-98">
                                            ...
                                            <option value="ebook" <?php if ($leadData->book_format == 'Ebook') {
                                                                        echo "selected";
                                                                    } ?>>eBook</option>
                                            <option value="paperback" <?php if ($leadData->book_format == 'Paperback') {
                                                                            echo "selected";
                                                                        } ?>>Paperback</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="package_data_for_s_c" style="<?php if (isset($leadData->lead_package_detail)) { ?>display:block; <?php } else { ?>display:none;<?php } ?>">
                                        <div class="form-group">
                                            ...
                                            <?php if ($leadData->book_format == 'paperback') { ?>
                                                                             <option value="elite" <?php if ($leadData->lead_package_name == 'elite') {
                                                                            echo "selected";
                                                                        } ?>>CUSTOM ELITE</option>
                                                                          <option value="rapid" <?php if ($leadData->lead_package_name == 'rapid') {
                                                            ...
                                                            <div class="sub_services_data_<?= $i; ?> sub_services<?= $i; ?>   subservices">
                                                                ...
                                                                foreach ($subservices as $subservice) {
                                                                    if ($subservice->subservice_name == 'Complimentary Author Copies') { ?>
                                                                        ...
                                                                        <input type="text"  id="complimentry_copies" name="complimentry_copies" onkeyup='myFunctiondatacomplimentry("<?= $data->id; ?>","<?=$data->cost ?>");'  class="form-control" value="<?= $leadData->complimentry_copies ?>" readonly >
                                                                        </div>
                                                                        </div>
                                                                   ...
                                                                   <?php } ?>
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <?php  if ($subservice->subservice_name == 'Complimentary Author Copies') { 
                                                                                  $total_cost_copy =  $leadData->complimentry_copies; ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <? } ?>
                                    <div class="ms_status_inprogess" <?php if ($leadData->ms_status == 'completed') { ?> style="display:show;" <? } else { ?> style="display:none;" <?php } ?>>
                                    ...
                                    <div class="ms_status_completed" <?php if ($leadData->ms_status == 'inprocess') { ?> style="display:show;" <? } else { ?> style="display:none;" <?php } ?>>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h3>Payment Schedule</h3>
                                            </div>
     ...
     <script>
        $(window).load(function() {
            ...
            <?php if ($leadData->lead_package_detail) { ?>
                ...
                var book_type = '<?= $leadData->book_format; ?>';
            ...
            var book_type = '<?php echo $leadData->book_format;?>';
            $('#book_type_value').val(book_type);
                    ...
                    $ii = count($service); ?>
                    $("#book_type_value").val('<?php echo $leadData->book_format; ?>');
                    $(".package_data_for_s_c").hide();
                    var counting = 0;
...
// console.log(val_of_color_of+'val_of_color_of');
val_of_color_of = val_of_color_of+(val_of_color_of*0.15);
// console.log(val_of_color_of+'val_of_color_of_after_15%');
if ($("#color_pages_number").val() != '') {
if (number_of_color <= total_color_par ) {
var cost_total1 = subsidPrice*additional_author_copy;
}else{
...
//custimze standadrd edit part
                ...
                var total_with_gross = total_amount_data+cost_of_additional;
                    ...
                    if ($(".customize_services div").hasClass("row-add" + i)) {
                        ...
                        for (var j = 0; j < subb_serviceArray.length; j++) {
                         ...
                         if (subb_serviceArray[j] == 'Format Editing') {
                            ...
                            var book_color_page =  $('#color_pages_customized').val();
                            htmldata += "<li>"+subb_serviceArray[j]+" ("+book_color_page+")</li>";
