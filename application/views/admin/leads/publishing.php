                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group" app-field-wrapper="discount">
                                        <label for="discount" class="control-label">Discount(%) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>NOTE: Use Numbers only (1-10)</b> </label>
            ...
            <?php if ($leadData->lead_package_detail) { ?>
                if ($("#msstatus").val() == 'completed' || $("#msstatus").val() == 'inprocess') {
                    $(document).ready(function() {
                        ...
                        <?php }else if (isset($leadData->gross_amt) && ($leadData->gross_amt != '') ) {?>
                          var total_amount_d = $("#additional_gross_amount").val();
                            <?php }else{ ?>
        ...
        $(document).ready(function() {
            $("#package_details").change(function() {
              ...
              if (this.value  == 3) {
                ...
                console.log("test package changed");
                //$("#div1").remove();
                //$('#getservicewithcost').remove(1000);
                //  $("#package_value").val(0);
    ...
    // alert('test');
        ...
        $(".preview-btn").click(function() {
         ...
         let   hasDisabledAttr =  document.querySelector('#book_size_sc').hasAttribute('disabled');
          ...
          if(hasDisabledAttr === true || ($("#book_cover_sc").val() == '---select----')){
                    ...
                    if ($(".customize_services div").hasClass("row-add" + i)) {
                        ...
                        for (var j = 0; j < subb_serviceArray.length; j++) {
                         ...
                         if (subb_serviceArray[j] == 'Format Editing') {
                            ...
                            var colorPages =  $('#color_pages_customized').val();
                            htmldata += "<li>"+subb_serviceArray[j]+" ("+colorPages+")</li>";
                        }
                        else{
