...
CREATE TABLE `tblprojectdiscussioncomments` (
  ...
  `discussion_type` varchar(10) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  ...
  `fullname` varchar(300) CHARACTER SET ascii COLLATE ascii_bin DEFAULT NULL,
  `file_name` varchar(300) CHARACTER SET ascii COLLATE ascii_bin DEFAULT NULL,
  `file_mime_type` varchar(70) CHARACTER SET ascii COLLATE ascii_bin DEFAULT NULL
