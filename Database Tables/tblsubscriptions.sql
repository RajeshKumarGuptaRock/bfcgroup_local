...
CREATE TABLE `tblsubscriptions` (
  ...
  `stripe_plan_id` text CHARACTER SET ascii COLLATE ascii_bin,
  `stripe_subscription_id` text CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `next_billing_cycle` bigint DEFAULT NULL,
  `ends_at` bigint DEFAULT NULL,
  `status` varchar(50) CHARACTER SET ascii COLLATE ascii_bin DEFAULT NULL,
