...
CREATE TABLE `tblprojectactivity` (
  ...
  `fullname` varchar(100) CHARACTER SET ascii COLLATE ascii_bin DEFAULT NULL,
  `visible_to_customer` int NOT NULL DEFAULT '0',
  `description_key` varchar(500) CHARACTER SET ascii COLLATE ascii_bin NOT NULL COMMENT 'Language file key',
