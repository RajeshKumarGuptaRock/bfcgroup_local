...
CREATE TABLE `tblknowledgebasegroups` (
  ...
  `group_slug` varchar(300) CHARACTER SET ascii COLLATE ascii_bin DEFAULT NULL,
  `description` mediumtext CHARACTER SET ascii COLLATE ascii_bin,
  `active` tinyint NOT NULL,
  `color` varchar(10) CHARACTER SET ascii COLLATE ascii_bin DEFAULT '#28B8DA',
