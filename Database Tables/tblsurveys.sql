...
CREATE TABLE `tblsurveys` (
  ...
  `viewdescription` text CHARACTER SET ascii COLLATE ascii_bin,
  `datecreated` datetime NOT NULL,
  `redirect_url` varchar(100) CHARACTER SET ascii COLLATE ascii_bin DEFAULT NULL,
  `send` tinyint(1) NOT NULL DEFAULT '0',
  `onlyforloggedin` int DEFAULT '0',
  `fromname` varchar(100) CHARACTER SET ascii COLLATE ascii_bin DEFAULT NULL,
