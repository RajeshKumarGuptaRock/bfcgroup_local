...
CREATE TABLE `tblrequestsgdpr` (
  ...
  `request_type` varchar(200) CHARACTER SET ascii COLLATE ascii_bin DEFAULT NULL,
  `status` varchar(40) CHARACTER SET ascii COLLATE ascii_bin DEFAULT NULL,
  `request_date` datetime NOT NULL,
  `request_from` varchar(150) CHARACTER SET ascii COLLATE ascii_bin DEFAULT NULL,
