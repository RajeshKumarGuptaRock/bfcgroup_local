...
--
-- Table structure for table `tblSaleReturnReport`
--

CREATE TABLE `tblSaleReturnReport` (
  `id` int NOT NULL,
  ...
  `return_date` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Indexes for table `tblSaleReturnReport`
--
ALTER TABLE `tblSaleReturnReport`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tblSaleReturnReport`
--
ALTER TABLE `tblSaleReturnReport`
